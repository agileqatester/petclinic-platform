...
**Consequences:**
- Positive: RDS hourly cost dies with workload destroy, same habit as NAT/EKS and saas-ntier-lab. Credentials are not orphaned in keep-stack SM at $0.40/month. Private, encrypted at rest and **in transit** (`require_secure_transport`), no public RDS, no customer CMK. PETPLAT-23 stays in E-5. Plan/validate can run without a live cluster.
